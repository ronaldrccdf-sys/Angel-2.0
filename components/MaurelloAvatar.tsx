...
export const MaurelloAvatar: React.FC<MaurelloAvatarProps> = ({ 
  ...
  // sm: Fixed small size for header/sidebar
  // lg: Responsive - 300px on mobile, 550px on desktop
  ...
  return (
    <div 
      className={`relative flex items-center justify-center ${dimension} transition-all duration-700 flex-shrink-0`}
    >
      {/* 
