    ...
    try {
        ...
        session.sendRealtimeInput({
            media: {
                ...
                data: arrayBufferToBase64(empty.buffer)
            }
        });
    } catch (e) {
...
1. You will hear a "DING" sound (or initial noise) immediately upon connection.
2. This is your absolute cue to speak the Welcome Message below IMMEDIATELY.
3. DO NOT analyze the "DING". Speak instantly.
